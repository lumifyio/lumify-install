class elasticsearch_securegraph_plugin::install inherits elasticsearch_securegraph_plugin {
  ...
  macro::download { 'elasticsearch-securegraph-plugin-download' :
    url   => "https://oss.sonatype.org/service/local/repositories/releases/content/org/securegraph/securegraph-elasticsearch-plugin/${elasticsearch_securegraph_plugin_version}/securegraph-elasticsearch-plugin-${securegraph_elasticsearch_plugin_version}.zip",
