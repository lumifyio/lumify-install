...
$clients = {
    ...
    :'vc-m1'        => { ip: '192.168.33.11',  mem: '1024', cpus: '1' },
    :'vc-m2'        => { ip: '192.168.33.12',  mem: '1024', cpus: '1' },
    :'vc-m3'        => { ip: '192.168.33.13',  mem: '1024', cpus: '1' },
    :'vc-hdn1'      => { ip: '192.168.33.111', mem: '1024', cpus: '1' },
    :'vc-hdn2'      => { ip: '192.168.33.112', mem: '1024', cpus: '1' },
    :'vc-hdn3'      => { ip: '192.168.33.113', mem: '1024', cpus: '1' },
